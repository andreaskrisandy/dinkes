<?php
    if (isset($_GET['id'])){
        ...
        echo "<p style=\"margin: 20px 0 0 0\" align=\"justify\">$query[deskripsi]</p>";
    } else {
        ...
        while ($galeri = mysql_fetch_array($query)){
            echo "<a href=\"?page=galeri&id=$galeri[id]\" title=\"$galeri[judul] - $galeri[deskripsi]\"><img src=\"galeri/$galeri[gambar]\" style=\"margin: 0 20px 25px 0; float: left; width: 30%; height: 150px\" /></a>";
        }
    }
?>
